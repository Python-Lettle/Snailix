...
interrupt_entry:
    ...
    ; Find the interrupt vector pushed by the previous 'push %1'
    mov eax, [esp + 12 * 4]
...
interrupt_exit:
    ...
    ; Corresponding to error code or push magic
    add esp, 8
    iret
...
INTERRUPT_HANDLER 0x28, 0; rtc real time clock
...
; The following array keeps a pointer to each interrupt entry function.
section .data
